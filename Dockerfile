...
RUN echo sonar.host.url=http://devops-sonarqube-sonarqube.devops.svc.cluster.local:9000 >> /opt/sonar-scanner-3.2.0.1227-linux/conf/sonar-scanner.properties && \
